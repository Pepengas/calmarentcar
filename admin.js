...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const rentalTimeLogic = {
        ...
        /**
         * Gets the description of rental time rules
         * @returns {string} - Description of rental time rules
         */
        getRentalTimeRules: function() {
            return `
                <div class="rental-rules">
                    <h3>Rental Time Rules</h3>
                    <ul>
                        <li>Pickup time: Between 07:00-08:00 AM</li>
                        <li>Return time: By 20:00-21:00 (8-9 PM)</li>
                        <li>Late return (after 22:00/10 PM) counts as an extra day</li>
                        <li>Only full days are charged</li>
                    </ul>
                </div>
            `;
        },
        
        validateBookingTimes: function(bookingData) {
            let errors = [];
            ...
            try {
                ...
                if (errors.length === 0) {
                    bookingData.rentalDays = this.calculateRentalDays(pickupDate, returnDate);
                    
                    // Explain late return charge if applicable
                    if (returnDate.getHours() >= 22) {
                        bookingData.lateReturnMessage = 'Note: Late return (after 22:00) adds an extra day charge';
                    }
                }
            } catch (e) {
    ...
    // Make rentalTimeLogic available globally
    window.rentalTimeLogic = rentalTimeLogic;
    ...
    const pages = {
        ...
        general: {
            ...
            content: `
                ...
                <div class="panel">
                    <div class="panel-header">
                        <h2 class="panel-title">Rental Time Rules</h2>
                    </div>
                    
                    <div class="panel-body">
                        <div class="settings-group">
                            <label>Rental Day Definition</label>
                            <div class="info-box">
                                <p>A single rental day starts at 07:00 (7 AM) and ends by 20:00–21:00 (8–9 PM).</p>
                            </div>
                        </div>
                        ...
                        <div class="settings-group">
                            ...
                            <div class="form-row">
                                <div>
                                    <label for="rental-start-time">Standard Pickup Time</label>
                                    <input type="time" id="rental-start-time" value="07:00" min="07:00" max="08:00">
                                    <p class="setting-help">All rentals must start in the morning, between 07:00–08:00 AM.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="settings-group">
                            ...
                            <div class="form-row">
                                <div>
                                    <label for="rental-end-time">Standard Return Time</label>
                                    <input type="time" id="rental-end-time" value="20:00" min="20:00" max="21:00">
                                    <p class="setting-help">All rentals must end by 20:00–21:00 on the final day.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="settings-group">
                            ...
                            <div class="info-box alert-box">
                                <p><i class="fas fa-exclamation-triangle"></i> If the return time exceeds 22:00 (10 PM) on the final day, it counts as an extra full rental day.</p>
                            </div>
                        </div>
                        ...
                        <div class="settings-group">
                            ...
                            <div class="info-box">
                                <p>No partial-day rentals — only full-day billing based on the above time windows.</p>
                            </div>
                        </div>
                        ...
                        <div class="settings-group">
                            ...
                            <div class="info-box example-box">
                                ...
                                <ul>
                                    <li>Rental from May 12 to May 14</li>
                                    <li>Pickup: May 12 at 08:00</li>
                                    <li>Return: May 14 by 20:00 (latest by 21:00)</li>
                                    <li>Total days charged: 2 days</li>
                                </ul>
                                
                                <p><strong>Example 2:</strong></p>
                                <ul>
                                    <li>Rental from May 14 to May 16</li>
                                    <li>Pickup: May 14 at 07:00–08:00</li>
                                    <li>Return: May 16 before 21:00</li>
                                    <li>Total days charged: 2 days</li>
                                </ul>
                                
                                <p><strong>Example 3 (Late Return):</strong></p>
                                <ul>
                                    <li>Rental from May 14 to May 16</li>
                                    <li>Pickup: May 14 at 07:00</li>
                                    <li>Return: May 16 at 22:30 (after 22:00)</li>
                                    <li>Total days charged: 3 days (extra day for late return)</li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    // Find the booking form handler and add validation
    document.querySelector('#bookingForm')?.addEventListener('submit', function(e) {
        ...
        const bookingData = {
            ...
            returnTime: document.querySelector('#returnTime').value,
            // Add other booking fields as needed
        };
        
        // Validate booking times
        const validation = rentalTimeLogic.validateBookingTimes(bookingData);
        
        if (!validation.isValid) {
            // Display validation errors
            const errorContainer = document.querySelector('#bookingErrors');
        ...
        // If valid, show rental days and continue with booking
        document.querySelector('#rentalDays').textContent = bookingData.rentalDays;
        if (bookingData.lateReturnMessage) {
            document.querySelector('#lateReturnNotice').textContent = bookingData.lateReturnMessage;
            document.querySelector('#lateReturnNotice').style.display = 'block';
        } else {
            document.querySelector('#lateReturnNotice').style.display = 'none';
        }
